...
public final class QueryParameters {
	...
	public void setFilteredPositionalParameterTypes(
			Type[] processedPositionalParameterTypes) {
		this.processedPositionalParameterTypes = processedPositionalParameterTypes;
	}

	public void setFilteredPositionalParameterValues(
			Object[] processedPositionalParameterValues) {
		this.processedPositionalParameterValues = processedPositionalParameterValues;
	}
}
