...
public abstract class EntityType extends AbstractType implements AssociationType
{
     ...
     * @param isEmbeddedInXML
     *            Should values of this mapping be embedded in XML modes?
     * @param unwrapProxy
     *            Is unwrapping of proxies allowed for this association; unwrapping says to return the
     *            "implementation target" of lazy prooxies; typically only possible with lazy="no-proxy".
     *
     * @deprecated Use
     *             {@link #EntityType(org.hibernate.type.TypeFactory.TypeScope, String, boolean, String, boolean, boolean)}
     *             instead. See Jira issue: <a href="https://hibernate.onjira.com/browse/HHH-7771">HHH-7771</a>
     */
    @Deprecated
    protected EntityType(TypeFactory.TypeScope scope, String entityName, String uniqueKeyPropertyName, boolean eager,
            boolean isEmbeddedInXML, boolean unwrapProxy)
    {
     ...
     * @param entityName
     *            The name of the associated entity.
     * @param referenceToPrimaryKey
     *            True if association references a primary key.
     * @param uniqueKeyPropertyName
     *            The property-ref name, or null if we reference the PK of the associated entity.
     * @param eager
     *            Is eager fetching enabled.
    ...
    /**
     * Does this association foreign key reference the primary key of the other table? Otherwise, it references a
     * property-ref.
     *
    ...
    /**
     * This returns the wrong class for an entity with a proxy, or for a named entity. Theoretically it should return
     * the proxy class, but it doesn't.
     * <p/>
     * The problem here is that we do not necessarily have a ref to the associated entity persister (nor to the session
     * factory, to look it up) which is really needed to "do the right thing" here...
     *
    ...
    private Class determineAssociatedEntityClass()
    {
        ...
        {
            return this.scope.resolveFactory().getEntityPersister(entityName).getEntityTuplizer().getMappedClass();
        }
    }
            ...
            throws HibernateException
    {
        ...
        else
        {
            ...
            {
                final Object copy = session.getEntityPersister(associatedEntityName, original).instantiate(null,
                        session);
    ...
    public Object resolve(Object value, SessionImplementor session, Object owner) throws HibernateException
    {
        ...
        if (partitionInfo.isPartition())
        {
            try
            {
                ...
                {
                    return loadByUniqueKey(getAssociatedEntityName(), uniqueKeyPropertyName,
                            value, session);
                }
            }
            finally
    ...
    protected final Object getIdentifier(Object value, SessionImplementor session) throws HibernateException
    {
        ...
        {
            return ForeignKeys.getEntityIdentifierIfNotUnsaved(getAssociatedEntityName(), value, session); // tolerates
                                                                                                           // nulls
        }
        else if (value == null)
        {
    ...
    /**
     * @deprecated To be removed in 5. Removed as part of removing the notion of DOM entity-mode. See Jira issue: <a
     *             href="https://hibernate.onjira.com/browse/HHH-7771">HHH-7771</a>
     */
    @Deprecated
    ...
    /**
     * Determine the type of either (1) the identifier if we reference the associated entity's PK or (2) the unique key
     * to which we refer (i.e. the property-ref).
     *
     * @param factory
     *            The mappings...
    ...
    protected final Object resolveIdentifier(Serializable id, SessionImplementor session) throws HibernateException
    {
        boolean isProxyUnwrapEnabled = unwrapProxy
                && session.getFactory().getEntityPersister(getAssociatedEntityName()).isInstrumented();

        Object proxyOrEntity = session.internalLoad(getAssociatedEntityName(), id, eager, isNullable()
                && !isProxyUnwrapEnabled);
